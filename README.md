...
- Think Python: How to Think Like a Computer Scientist (CC BY-NC 3.0) [webpage](http://greenteapress.com/wp/think-python-2e/)
- Dive into Python 3 CC (GFDLv1.1) [webpage](http://getpython3.com/diveintopython3/)
- Automate the Boring Stuff with Python (CC BY-NC-SA 3.0) [webpage](https://automatetheboringstuff.com/)
- The Hitchhiker’s Guide to Python (CC BY-NC-SA 3.0) [webpage](http://docs.python-guide.org/en/latest/)
- Supporting Python 3 (CC BY-NC-SA 3.0) [webpage](http://python3porting.com/)
...
- A Byte of Python (CC BY-NC-SA 3.0) [webpage](https://python.swaroopch.com/)
- Programming Computer Vision with Python (CC ?) [webpage](http://programmingcomputervision.com/)
